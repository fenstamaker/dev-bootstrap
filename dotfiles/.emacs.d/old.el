...
(setq package-list '(undo-tree smartparens helm web-mode cider company flycheck rainbow-delimiters))
...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (rainbow-delimiters web-mode undo-tree smartparens helm flycheck company cider))))
(custom-set-faces
